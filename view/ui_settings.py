...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        sizePolicy1.setHeightForWidth(self.label_driver_settings.sizePolicy().hasHeightForWidth())
        self.label_driver_settings.setSizePolicy(sizePolicy1)
        font = QFont()
        ...
        sizePolicy1.setHeightForWidth(self.label_common_settings.sizePolicy().hasHeightForWidth())
        self.label_common_settings.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.label_pylonen_penaltytime.sizePolicy().hasHeightForWidth())
        self.label_pylonen_penaltytime.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.spinBox_pylon_penaltytime.sizePolicy().hasHeightForWidth())
        self.spinBox_pylon_penaltytime.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.label_tor_penaltytime.sizePolicy().hasHeightForWidth())
        self.label_tor_penaltytime.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.spinBox_tor_penaltytime.sizePolicy().hasHeightForWidth())
        self.spinBox_tor_penaltytime.setSizePolicy(sizePolicy3)
